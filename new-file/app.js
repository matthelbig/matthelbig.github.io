(function ($, window, document, undefined) {
  ...
  // Collapse responsive menu when item is selected
  jQuery('#bs-example-navbar-collapse-1 a').on('click', function() {
  ...
  // IMAGINE cube portfolio
	var gridContainer2 = $('#grid-container-imagine');
